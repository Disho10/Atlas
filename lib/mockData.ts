...
export type Product = {
  ...
  reviewCount: number;
  image: string;
  images: string[];  // additional gallery photos (hero is `image`)
  color: string;
...
export const products: Product[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1552667466-07770ae110d0?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 89}, {label: 'Jersey + Shorts', price: 119}], color: '#FFFFFF'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 89}, {label: 'Jersey + Shorts', price: 119}], color: '#04124A'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 92}, {label: 'Jersey + Shorts', price: 122}], color: '#6CABDD'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 87}, {label: 'Jersey + Shorts', price: 117}], color: '#0B0D10'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1614632537190-23e4146777db?q=80&w=800&auto=format&fit=crop', images: [], variants: [], color: '#FFFFFF'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?q=80&w=800&auto=format&fit=crop', images: [], variants: [], color: '#E63946'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=800&auto=format&fit=crop', images: [], variants: [], color: '#12161B'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1483721310020-03333e577078?q=80&w=800&auto=format&fit=crop', images: [], variants: [], color: '#F5F3EE'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1489944440615-453fc2b6a9a9?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 89}, {label: 'Jersey + Shorts', price: 119}], color: '#04164A'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1518091043644-c1d4457512c6?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 88}, {label: 'Jersey + Shorts', price: 118}], color: '#DC052D'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1543326727-cf6c39e8f84c?q=80&w=800&auto=format&fit=crop', images: [], variants: [{label: 'Jersey', price: 55}, {label: 'Jersey + Shorts', price: 80}], color: '#00693E'
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1556906781-9a412961c28c?q=80&w=800&auto=format&fit=crop', images: [], variants: [], color: '#0B0D10'
  },
];
