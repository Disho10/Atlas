...
const DEFAULT_SLIDES = [
  ...
  {
    tag: 'From the archive · limited numbers',
    titleTop: 'THE KITS THAT',
    titleAccent: 'STARTED IT.',
    body: 'Classic and vintage shirts from eras before this one — sourced in limited numbers. When a size sells out, it\'s gone for good.',
    image: '',
    imageScale: 100, imageX: 50, imageY: 50, imageRotation: 0,
    ctaLabel: 'Shop retro',
    ctaHref: '/retro',
